...
public class NormalMapping implements Scene {
    private static final String PATH = "/Users/vinil/Desktop/PUCPR/EmptySkydomeimg/opengl/";
    ...
    public void init() {
        ...
        Texture stone = new Texture(PATH + "textures/bricks_t.jpg");
        ...
        materialNM.setNormalMap(new Texture(PATH + "normals/bricks_n.jpg"));
    }
